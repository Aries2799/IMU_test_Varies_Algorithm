...
(cl:defmethod roll-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:roll-val is deprecated.  Use imu_yesense_ros-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:pitch-val is deprecated.  Use imu_yesense_ros-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:yaw-val is deprecated.  Use imu_yesense_ros-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImuExtended>)))
  ...
  "c35cf7f7950d0a3072b3fda30e7bb610")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImuExtended)))
  "Returns md5sum for a message object of type 'ImuExtended"
  "c35cf7f7950d0a3072b3fda30e7bb610")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ImuExtended>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 angular_velocity_x~%float64 angular_velocity_y~%float64 angular_velocity_z~%float64 magnetic_x~%float64 magnetic_y~%float64 magnetic_z~%float64 roll~%float64 pitch~%float64 yaw~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ImuExtended)))
  "Returns full string definition for message of type 'ImuExtended"
  (cl:format cl:nil "std_msgs/Header header~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 angular_velocity_x~%float64 angular_velocity_y~%float64 angular_velocity_z~%float64 magnetic_x~%float64 magnetic_y~%float64 magnetic_z~%float64 roll~%float64 pitch~%float64 yaw~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
