...
(cl:defclass <ImuExtended> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ImuExtended (<ImuExtended>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ImuExtended>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ImuExtended)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_yesense_ros-msg:<ImuExtended> is deprecated: use imu_yesense_ros-msg:ImuExtended instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:header-val is deprecated.  Use imu_yesense_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'acc_x-val :lambda-list '(m))
(cl:defmethod acc_x-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:acc_x-val is deprecated.  Use imu_yesense_ros-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <ImuExtended>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_yesense_ros-msg:acc_y-val is deprecated.  Use imu_yesense_ros-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'acc_z-val :lambda-list '(m))
(cl:defmethod acc_z-val ((m <ImuExtended>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImuExtended>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ImuExtended>)))
  "Returns string type for a message object of type '<ImuExtended>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ImuExtended>))
